    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Creado el {formatOrderDateTime(order.createdAt, { emptyLabel: "-" })}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className={`p-3 rounded-lg bg-secondary/50 ${order.status !== "CANCELLED" ? "border-2 border-green-500" : ""}`}>
              ...
              <p className="text-xs font-medium">{formatOrderDateTime(order.createdAt, { emptyLabel: "-" })}</p>
            </div>
            <div className={`p-3 rounded-lg bg-secondary/50 ${order.confirmedAt ? "border-2 border-green-500" : ""}`}>
              ...
              <p className="text-xs font-medium">{formatOrderDateTime(order.confirmedAt, { emptyLabel: "-" })}</p>
            </div>
            <div className={`p-3 rounded-lg bg-secondary/50 ${order.shippedAt ? "border-2 border-green-500" : ""}`}>
              ...
              <p className="text-xs font-medium">{formatOrderDateTime(order.shippedAt, { emptyLabel: "-" })}</p>
            </div>
          </div>
